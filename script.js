...
function onGameOver() {
    ...
    startScreen.innerHTML = "Game Over!<br>Final score: <b>" + player.score + "</b><br><br>Click or tap here to restart";
}
...
function moveUp(){
	if(held.u && player.y > (road.top + 70))
		player.y -= player.speed;
	}
function moveDown(){
	if(held.d && player.y < (road.bottom - 85))
		player.y += player.speed;
	}
function moveLeft(){
	if(held.l && player.x > 0)
		player.x -= player.speed;
	}
function moveRight(){
	if(held.r && player.x < (road.width - 70))	
		player.x += player.speed;
	}